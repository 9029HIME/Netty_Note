...
public class InitHandler extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        TODO 这里添加的是netty内置的handler，可以实现心跳效果
            ...
            值得注意的是：如果客户端手动关闭连接，服务端是会接受到设置个时间，并调用handlerRemove和channelInactive
            这一点在三次握手四次挥手是可以知道的
        ...
        /*
        TODO 当发现断连后，会触发特定的断连事件IdleStateEvent，然后将该IdleStateEvent交给下一个Handler的userEventTriggered()方法
            内处理，该方法用来专门处理断连事件
         */
